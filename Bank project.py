...
print(check_balance("checking", 0, 0))


# In[11]:


print(check_balance("savings", 0, 0))
...
print(make_deposit("savings", 10, checking_balance, savings_balance))
...
def make_withdrawel(account_type, amount, checking_balance, savings_balance):
    withdrawel_status = ""
    ...
    if account_type == "checking":
        ...
        withdrawel_status = "unsuccessful, please enter \"checking\" or \"savings\""

    withdrawel_statement = "Withdrawal of " + str(amount) + " from your " + account_type + " was " + deposit_status
    
    print(withdrawel_statement)
    
    return checking_balance, savings_balance


savings_balance, checking_balance = make_withdrawel("savings",12,checking_balance,savings_balance)

print(check_balance("savings",checking_balance,savings_balance))

savings_balance, checking_balance = make_withdrawel("checking", 170, checking_balance, savings_balance)
...
checking_balance, savings_balance = acc_transfer("checking", "savings", 30, checking_balance, savings_balance)
